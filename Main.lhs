...
> solveMaze maze start target = solveMazeIter maze target queue
> 	where 	queue = [(start, [])]
...
> possibleMoves :: Maze -> Place -> Path -> [PartialSolution]
