...
We'll represent a piece of wall by a place and a direction.  For example,
((3,4), N) means that there is a wall to the North of (3,4), and to the South
of (3,5).

> type Wall = (Place, Direction)

A size of (x,y) represents that the squares are numbered (i,j) for i <- [0..x)
and j <- [0..y).
